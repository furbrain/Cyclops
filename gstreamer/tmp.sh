...
gst-launch-1.0 \
    py_TOF_Cam ! video/x-raw,width=960,height=180,framerate=30/1,format=I420 !\
    v4l2h264enc extra-controls="controls,video_bitrate_mode=0,h264_minimum_qp_value=0,h264_maximum_qp_value=0,h264_i_frame_period=30,h264_profile=3,h264_level=11;" !\
